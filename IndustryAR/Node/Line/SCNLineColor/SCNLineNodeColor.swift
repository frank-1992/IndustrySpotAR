...
public class SCNLineNodeColor: SCNNode {
    ...
    public private(set) var colors: [SCNVector3] {
        didSet {
            self.update()
        }
    }
    ...
    public private(set) var gParts: GeometryPartsColor?
    ...
    public init(with points: [SCNVector3] = [], colors: [SCNVector3] = [], radius: Float = 1, edges: Int = 8, maxTurning: Int = 4) {
        self.points = points
        self.colors = colors
    ...
    public func add(point: SCNVector3, color: SCNVector3) {
        // TODO: optimise this function to not recalculate all points
        self.add(points: [point], colors: [color])
    }
    
    /// Add a point to the collection for this SCNLineNode
    ///
    /// - Parameter points: points to be added to the line
    public func add(points: [SCNVector3], colors: [SCNVector3]) {
        // TODO: optimise this function to not recalculate all points
